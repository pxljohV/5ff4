...
import cocoa_bg from "./assets/cocoa-bg.gif"
import cocoa_icon from "./assets/cocoa-full.gif"
import blaine_bg from "./assets/blaine-bg.gif"
import blaine_icon from "./assets/blaine-full.gif"
import pomme_bg from "./assets/pomme-bg.gif"
import pomme_icon from "./assets/pomme-full.gif"
import stralechi_bg from "./assets/stralechi-bg.gif"
import stralechi_icon from "./assets/stralechi-full.gif"
import pebbles_bg from "./assets/pebbles-bg.gif"
import pebbles_icon from "./assets/pebbles-full.gif"

import { useState, useEffect } from 'react'


const refsArray = Array(5).fill().map(() => React.createRef());
const init = 0
