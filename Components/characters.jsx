...
export default function Characters() {
  const [chars, setChars] = useState([]); // Changed 'char' to 'chars' for consistency
  const [currentChar, setCurrentChar] = useState(null); // Changed initial value to null
    ...
    <div className="ma0  ph4 pv4 white ">
      <div className="ma0 ">
        ...
        <div className=" black w-100 pv4 flex justify-center">
          <div className="  f2-ns f3-m f4 shadow-text relative white">
                ...
                <div className="w-50-l w-100 pa4-l lh-2 bg-black-70   ">
                  {currentChar && (
                    <p className="f3-l f4-m f5 ">
                      <span className="pink b">{currentChar.name}</span>
                      {currentChar.desc}
                    </p>
                  )}
                </div>
